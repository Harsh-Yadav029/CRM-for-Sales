...
const GlobalSearch = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-slate-950/60 p-4 pt-16 md:pt-28 backdrop-blur-sm" onClick={onClose}>
      <div
        className="w-full max-w-xl rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl overflow-hidden flex flex-col max-h-[70vh]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Search Input field bar */}
        <div className="relative border-b border-slate-850 bg-slate-900/50 p-4 flex items-center gap-3">
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[9px] text-slate-500 uppercase tracking-wider font-semibold mt-0.5">{item.type}</p>
                      </div>
                    </div>
        ...
        <div className="border-t border-slate-850 bg-slate-950/80 px-4 py-2 flex justify-between text-[9px] text-slate-500 font-semibold uppercase tracking-wider">
