    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">Track paid, unpaid, and overdue client balances</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 rounded-2xl border border-dashed border-slate-800 bg-slate-900/10">
          ...
          <h3 className="mt-4 text-sm font-bold text-white">No Invoices Found</h3>
          <p className="mt-2 text-xs text-slate-400">Bill client accounts by configuring standard invoices</p>
        </div>
      ) : (
            ...
            >
              <div>
                <div className="flex justify-between items-start gap-4">
                  <div>
                    <h3 className="text-sm font-bold text-white leading-snug">{inv.invoiceNumber}</h3>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto custom-scroll">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-extrabold uppercase tracking-wider text-slate-400 mb-1">Invoice Number *</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-extrabold uppercase tracking-wider text-slate-400 mb-1">Bill-to Account (Company) *</label>
                  <select
                    required
                ...
                <div>
                  <label className="block text-[10px] font-extrabold uppercase tracking-wider text-slate-400 mb-1">Reference Quote (Optional)</label>
                  <select
                    className="w-full rounded-lg border border-slate-800 bg-slate-950 px-3 py-2 text-xs text-white focus:border-amber-500 focus:outline-none"
                    value={form.quoteId}
              ...
              {/* Status Select */}
              <div>
                <label className="block text-[10px] font-extrabold uppercase tracking-wider text-slate-400 mb-1">Invoice Status</label>
                <select
                  className="w-full rounded-lg border border-slate-800 bg-slate-950 px-3 py-2 text-xs text-white focus:border-amber-500 focus:outline-none"
                  value={form.status}
              ...
              <div className="space-y-3 border-t border-slate-850 pt-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider">Invoice Line Items</h4>
                  <button
                    type="button"
              ...
              <div className="flex justify-between items-center bg-slate-950 p-4 rounded-xl border border-slate-800/80 mt-6">
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Gross Invoice Total</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-sm overflow-y-auto" onClick={() => setShowPreviewModal(false)}>
          ...
          >
            ...
            <div className="flex justify-between items-start border-b border-slate-200 pb-6 mt-6 print:mt-0">
              <div>
                <h1 className="text-2xl font-extrabold tracking-tight text-amber-500 uppercase">COMMERCIAL INVOICE</h1>
                <p className="text-xs text-slate-500 mt-1 font-mono">Invoice ID: #{previewInvoice.invoiceNumber}</p>
              </div>
              <div className="text-right text-xs space-y-1">
                <h3 className="font-bold text-slate-800">Walk the Plan CRM</h3>
                <p className="text-slate-500">Finance & Collections Department</p>
                <p className="text-slate-500">Date: {new Date(previewInvoice.createdAt).toLocaleDateString()}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8 my-6 text-xs">
              ...
              <div>
                <h4 className="font-bold text-slate-400 uppercase tracking-wider mb-2">Payment Terms:</h4>
